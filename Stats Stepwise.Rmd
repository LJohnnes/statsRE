...
reg.fit.fwd = regsubsets(PriceSqrt~Year.Built+X..Beds.Total+X..Baths.Full+X..Baths.Half+X..Living+X..Garage.Spaces+X..Living+listMonth+soldMonth+floor+ADOM+CDOM+List.Price+Price.Diff+dayssale, data=modelData, method="forward")

reg.fit.bwd = regsubsets(PriceSqrt~Year.Built+X..Beds.Total+X..Baths.Full+X..Baths.Half+X..Living+X..Garage.Spaces+X..Living+listMonth+soldMonth+floor+ADOM+CDOM+List.Price+Price.Diff+daysale, data=modelData, method="backward")
